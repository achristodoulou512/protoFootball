...
class StadiumRequest$Type extends MessageType {
    constructor() {
        super("stadiums.StadiumRequest", [
            { no: 1, name: "stadium_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "city", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "country_code", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "capacity", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.stadiumId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.stadiumId);
        /* string name = 2; */
        if (message.name !== "")
        ...
        if (message.capacity !== 0)
            writer.tag(5, WireType.Varint).uint32(message.capacity);
        /* string created_by = 6; */
...
class ActionResponse$Type extends MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string stadium_id = 3; */
        if (message.stadiumId !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.stadiumId);
        /* string name = 4; */
        if (message.name !== "")
        ...
        /* uint32 capacity = 7; */
        if (message.capacity !== 0)
            writer.tag(7, WireType.Varint).uint32(message.capacity);
        /* string created_by = 8; */
        if (message.createdBy !== "")
 ...
 */
export const StadiumService = new ServiceType("stadiums.StadiumService", [
    { name: "AddStadium", options: {}, I: StadiumRequest, O: ActionResponse }
]);
