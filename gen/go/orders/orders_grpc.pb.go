...
const (
	OrdersService_AddOrders_FullMethodName = "/orders.OrdersService/AddOrders"
)
...
type OrdersServiceClient interface {
	AddOrders(ctx context.Context, in *OrdersRequest, opts ...grpc.CallOption) (*ActionResponse, error)
}
...
func (c *ordersServiceClient) AddOrders(ctx context.Context, in *OrdersRequest, opts ...grpc.CallOption) (*ActionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActionResponse)
	err := c.cc.Invoke(ctx, OrdersService_AddOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrdersServiceServer interface {
	AddOrders(context.Context, *OrdersRequest) (*ActionResponse, error)
}
...
func (UnimplementedOrdersServiceServer) AddOrders(context.Context, *OrdersRequest) (*ActionResponse, error) {
...
func _OrdersService_AddOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrdersServiceServer).AddOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrdersService_AddOrders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).AddOrders(ctx, req.(*OrdersRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrdersService_AddOrders_Handler,
		},
	},
